...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(8, "flowing_water", (new BlockDynamicLiquid(Material.water)).setHardness(100.0F).setLightOpacity(Blocks.flowing_water, 3).setUnlocalizedName("water").disableStats());
        registerBlock(9, "water", (new BlockStaticLiquid(Material.water)).setHardness(100.0F).setLightOpacity(Blocks.flowing_water, 3).setUnlocalizedName("water").disableStats());
        ...
        registerBlock(30, "web", (new BlockWeb()).setLightOpacity(Blocks.flowing_water, 1).setHardness(4.0F).setUnlocalizedName("web"));
        ...
        registerBlock(78, "snow_layer", (new BlockSnow()).setHardness(0.1F).setStepSound(soundTypeSnow).setUnlocalizedName("snow").setLightOpacity(Blocks.flowing_water, 0));
        registerBlock(79, "ice", (new BlockIce()).setHardness(0.5F).setLightOpacity(Blocks.flowing_water, 3).setStepSound(soundTypeGlass).setUnlocalizedName("ice"));
        ...
        registerBlock(171, "carpet", (new BlockCarpet()).setHardness(0.1F).setStepSound(soundTypeCloth).setUnlocalizedName("woolCarpet").setLightOpacity(Blocks.flowing_water, 0));
    ...
    Block setLightOpacity(BlockDynamicLiquid flowing_water, int opacity) {
        this.lightOpacity = opacity;
        return this;
    }
